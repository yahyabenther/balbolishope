...
export default function ProductDetail() {
  ...
  // field instead of the boolean "inStock" flag added later.
  const isInStock =
    ...
    <div className="container">
      ...
      <div className="product-detail">
        ...
        <div className="product-detail__info">
          ...
          <div className={`product-detail__stock-status ${isInStock ? "in" : "out"}`}>
          ...
          <div className="product-detail__actions">
            ...
            <button
              className={`btn ${isInStock ? "btn-accent" : "btn-outline"}`}
