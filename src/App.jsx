          ...
          <SettingsProvider>
            <AdminUsersProvider>
              ...
              <Routes>
                ...
                >
                  {/* Dashboard, Clients, and Paramètres are admin-only —
                      moderators are redirected to Commandes by
                      AdminOnlyRoute. Produits and Commandes stay open
                      to both admins and moderators. */}
                  <Route
                    index
                    element={
                      <AdminOnlyRoute>
